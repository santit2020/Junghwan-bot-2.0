...
class GeminiClient:
    ...
    def __init__(self, api_keys: Optional[List[str]] = None):
        if not api_keys:
            # Load keys from environment variable if not explicitly provided
    ...
    def _post_process_response(self, text: str, language: str, tone: str) -> str:
        # Keep your original post-processing logic here as needed.
        return text
    ...
    def _handle_failure(self):
        ...
        if self.failure_count >= self.max_failures:
            ...
            self.circuit_reset_time = time.time() + 300  # 5 minutes cooldown
